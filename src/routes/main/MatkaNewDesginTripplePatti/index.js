...
const MatkaNewDesginTripplePatti = () => {
  ...
  return (
    ...
    <Typography  className="gx-text-grey gx-fs-xxl gx-font-weight-bold gx-text-center gx-pb-3">TRIPPLE PATTI</Typography>
    <Form >
      <Row gutter={[16, 16]} justify="space-between" align="middle">
        
        {["000", "111", "222", "333", "444", "555", "666", "777", "888", "999"].map((number) => (
...
export default MatkaNewDesginTripplePatti;
